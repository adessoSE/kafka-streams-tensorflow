package de.adesso.kafkaml.sample;
...
// Integrated
// https://github.com/kaiwaehner/kafka-streams-machine-learning-examples/blob/master/src/main/java/com/github/megachucky/kafka/streams/machinelearning/Kafka_Streams_TensorFlow_Image_Recognition_Example.java

public class ModelServing {
    ...
    public static void main(String[] args) throws Exception {
        String imageInputTopic = "unknown";
        String imageOutputTopic = "unknown";

        String modelDir = "/opt/software/tensorflow/fraud/";
        ...
        imageInputLines.foreach((key, value) -> {
            ...
            Path pathImage = Paths.get(value);
            byte[] imageBytes;
            try {
